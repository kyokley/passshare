...
APPS_DIR = ROOT_DIR.path('passshare')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///passshare'),
}
...
MIGRATION_MODULES = {
    'sites': 'passshare.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'passshare.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'passshare.users.adapters.SocialAccountAdapter'
